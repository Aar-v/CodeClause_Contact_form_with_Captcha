...
Responsibilities: Design of the Contact form with Captcha Frontend.
...
*Style.css :The style.css file is written to style the background of website and container
            which store the input label and tasks.

*app.js :The app.js is used to provide a interactive interface to our Contact form along with a regenerating captcha  addEventListener() method of dom.
